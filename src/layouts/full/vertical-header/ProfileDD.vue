...
<template>
  ...
  <!-- profile DD -->
  <!-- ---------------------------------------------- -->
  <div class="pa-4" v-if="authStore.user">
    <h4 class="mb-n1">Good Morning, <span class="font-weight-regular">{{authStore.user.name}} </span></h4>
...
<!--      </div>-->
      ...
      <v-list class="mt-3">
        <v-list-item color="secondary" rounded="md">
          ...
          <v-list-item-title class="text-subtitle-2"> Paramètres du compte</v-list-item-title>
        </v-list-item>
...
<!--&lt;!&ndash;          <v-list-item-title class="text-subtitle-2"> Social Profile</v-list-item-title>&ndash;&gt;-->
